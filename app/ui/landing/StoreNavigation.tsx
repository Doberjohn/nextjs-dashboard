...
const CompanyLogo = () => {
   return (
      <div>
         <span className="sr-only">Megabyte Concept</span>
         <Image
            className="w-auto"
            src="/megabyte-concept-logo.png"
            width={40}
            height={40}
            alt={`Megabyte Concept logo`}
         />
      </div>
   )
}

const AccountConnectSection = () => {
   return (
...
const SearchSection = () => {
   return (
      <div className="hidden lg:ml-8 lg:flex lg:ml-6">
...
const MobileAccountConnectSection = () => {
   return (
      <div className="space-y-6 border-t border-gray-200 px-4 py-6">
